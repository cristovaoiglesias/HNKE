...
# (mAb_synthetic_dt.sol_SPN_testingset1[:,:],sol_SPN_gt,"SPN_testingset1"),
# (mAb_synthetic_dt.sol_SPN_testingset2[:,:],sol_SPN_gt,"SPN_testingset2"),
(mAb_synthetic_dt.sol_SPN_testingset3[:,:],sol_SPN_gt_7min,"SPN_testingset3",0.969e8,600000.0,0.92e8,600000.0),
(mAb_synthetic_dt.sol_SPN_testingset4[:,:],sol_SPN_gt_7min,"SPN_testingset4",0.969e8,600000.0,0.92e8,600000.0),
...
# (mAb_synthetic_dt.sol_SP4_testingset1[:,:],sol_SP4_gt,"SP4_testingset1"),
# (mAb_synthetic_dt.sol_SP4_testingset2[:,:],sol_SP4_gt,"SP4_testingset2")
(mAb_synthetic_dt.sol_SP4_testingset3[:,:],sol_SP4_gt_7min,"SP4_testingset3",1.1e8,3.1e7,1.0e8,3.1e7),
(mAb_synthetic_dt.sol_SP4_testingset4[:,:],sol_SP4_gt_7min,"SP4_testingset4",1.1e8,3.1e7,1.0e8,3.1e7)
]                                                                              #R , #Q
...
##### Classic CKF
    ...
    for s = 1:6
        plot!(plots[s], tgrid_opt[2:end], MM'[:,s], label = "ENN+CKF", grid=false,ribbon= (1/2)*1.645 .*sqrt.(PP[s,s,:]),fillalpha=.3,color=:orange, lw=lws)
    end
    display(plots)
